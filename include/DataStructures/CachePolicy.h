// CACHE_POLICY_TYPE defines the type of the key you want to use in a CachePolicy.
// CACHE_POLICY_TYPE_NAME defines the name suffix of a CachePolicy.
// If CACHE_POLICY_TYPE_NAME = Int,
// CachePolicy becomes CachePolicyInt, cachePolicyAlloc becomes cachePolicyIntAlloc.
...
// If no key should be removed from the cache, CACHE_POLICY_ADD_NO_REPLACE is returned.
// If a key should be removed from the cache, CACHE_POLICY_ADD_REPLACE is returned
// and the key that should be removed is written to replace.
