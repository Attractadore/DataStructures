...
#define OHT_UPPER_NAME                                                         \
  CONCAT(CONCAT(OHT, OHT_KEY_TYPE_NAME), OHT_VALUE_TYPE_NAME)
#define OHT_LOWER_NAME                                                         \
  CONCAT(CONCAT(oht, OHT_KEY_TYPE_NAME), OHT_VALUE_TYPE_NAME)
...
static inline OHT_NAME *
OHT_LOWER_IDENTIFIER(Alloc)(const OHT_HASH_FUNC hash_func,
                            const OHT_COMPARE_FUNC compare_func) {
  return (OHT_NAME *)baseOHTInit(
      sizeof(OHT_KEY_TYPE), _Alignof(OHT_KEY_TYPE), sizeof(OHT_VALUE_TYPE),
      _Alignof(OHT_VALUE_TYPE), (BaseHashFunc)hash_func,
...
static inline OHT_VALUE_TYPE *
OHT_LOWER_IDENTIFIER(Insert)(OHT_NAME *const table, OHT_KEY_TYPE const key,
                             OHT_VALUE_TYPE const value) {
...
static inline OHT_VALUE_TYPE *
OHT_LOWER_IDENTIFIER(Find)(OHT_NAME *const table, OHT_KEY_TYPE const key) {
...
static inline OHT_VALUE_TYPE *OHT_LOWER_IDENTIFIER(FindOrInsert)(
    OHT_NAME *const table, OHT_KEY_TYPE const key, OHT_VALUE_TYPE const value) {
  return baseOHTFindOrInsert((BaseOHT *)table, &key, &value);
}

// ohtDelete: Delete a key from a hash table.
static inline void OHT_LOWER_IDENTIFIER(Delete)(OHT_NAME *const table,
                                                OHT_KEY_TYPE const key) {
