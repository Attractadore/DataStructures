...
typedef int (*BIN_HEAP_ORDER_FUNC)(BIN_HEAP_TYPE const*, BIN_HEAP_TYPE const*);

// binHeapAlloc: Create a new BinHeap.
static inline BIN_HEAP_NAME* BIN_HEAP_LOWER_IDENTIFIER(Alloc)(const BIN_HEAP_ORDER_FUNC order_func) {
    return (BIN_HEAP_NAME*) baseBinHeapAlloc(sizeof(BIN_HEAP_TYPE), (BaseOrderFunc) order_func);
}
...
static inline BIN_HEAP_TYPE BIN_HEAP_LOWER_IDENTIFIER(Pop)(BIN_HEAP_NAME* const heap) {
    BIN_HEAP_TYPE value;
...
static inline bool BIN_HEAP_LOWER_IDENTIFIER(Insert)(BIN_HEAP_NAME* const heap, BIN_HEAP_TYPE const value) {
    return baseBinHeapInsert((BaseBinHeap*) heap, &value);
}

// binHeapSize: Get the size of a BinHeap.
static inline size_t BIN_HEAP_LOWER_IDENTIFIER(Size)(BIN_HEAP_NAME const* const heap) {
