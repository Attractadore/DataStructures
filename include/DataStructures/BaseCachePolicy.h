...
BaseCachePolicy *baseCachePolicyAlloc(size_t capacity, size_t key_size,
                                      size_t key_align, BaseHashFunc hash_func,
                                      BaseCompareFunc compare_func,
                                      CacheAlgorithm algorithm);
void baseCachePolicyFree(BaseCachePolicy *cache_policy);

bool baseCachePolicyContains(BaseCachePolicy const *cache_policy,
                             void const *key);

CachePolicyAddResult baseCachePolicyAdd(BaseCachePolicy const *cache_policy,
                                        void const *key, void *replace);
