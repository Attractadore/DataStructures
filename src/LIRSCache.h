...
// lirsCacheAlloc - create LIRSCache structure with hash_table, mono_list, capacity
...
// lirsCacheAddorReplace - adds key into cash and tells wich one was removed from cache
